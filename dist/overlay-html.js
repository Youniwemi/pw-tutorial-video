...
export function renderContextOverlay(params) {
...
export function renderCompleteOverlay(params) {
...
export function renderEmailPreview(params) {
    ...
    if (highlightCode) {
		...
		`;
        displayBody = highlightStyle + body.replace(new RegExp(`(${highlightCode})`, 'g'), `<span class="tutorial-code-highlight">$1</span>`);
    }
...
//# sourceMappingURL=overlay-html.js.map