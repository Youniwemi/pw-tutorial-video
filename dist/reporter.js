...
class TutorialMergeReporter {
     ...
     */
    detectSyncMarker(videoPath) {
        try {
            const out = execSync(`ffmpeg -hide_banner -i "${videoPath}" -vf "blackdetect=d=0.2:pic_th=0.95" -an -f null - 2>&1`, { encoding: 'utf-8', maxBuffer: 32 * 1024 * 1024 });
